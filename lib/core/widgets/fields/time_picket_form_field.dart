                  ...
                  child: MyCard(
                    ...
                    child: CupertinoDatePicker(
                      ...
                      onDateTimeChanged: (newTime) {
                        var formattedTime = DateFormat('h:mm a').format(newTime);
                        var time = formattedTime.substring(0, formattedTime.lastIndexOf(' '));
                        var period = formattedTime.substring(formattedTime.lastIndexOf(' ') + 1).toUpperCase();
