...
class _MyDefaultCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final Color? cardColor = color ?? (type == _MyCardType.primary ? context.primary.withAlpha(50) : null);
    Border? newBorder = border ?? (_MyCardType.outline == type ? Border.all(color: Colors.grey.withAlpha(50)) : null);
    return Padding(
      padding: margin,
      child: InkWell(
        onTap: onTap,
          ...
          child: Material(
            ...
            child: Ink(
              ...
              decoration: decoration.copyWith(
                ...
                boxShadow: [
                  BoxShadow(
                    color: elevation == 0 ? Colors.transparent : shadowColor ?? context.shadow.withValues(alpha: 250 * 0.2),
