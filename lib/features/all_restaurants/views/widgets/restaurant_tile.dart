      ...
      child: Row(
        ...
        children: [
          Container(
            ...
            child: Center(child: Icon(LucideIcons.utensils, color: context.onPrimary)),
          ),
            ...
            child: Column(
              ...
              children: [
                Row(
                  children: [
                    Text(
                      item.name.isNotEmpty ? item.name : AppStrings.noName,
                ...
                Text(
                  item.address.isNotEmpty ? item.address : AppStrings.noAddress,
                ...
                Row(
                  children: [
                    ...
                    Text(
                      '${item.city}, ${item.zipCode > 0 ? item.zipCode : AppStrings.unknownZip}',
