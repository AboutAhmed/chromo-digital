...
import 'package:chromo_digital/config/theme/app_theme.dart';
import 'package:chromo_digital/config/theme/extensions/app_color_extension.dart';
import 'package:chromo_digital/config/theme/typography.dart';
import 'package:chromo_digital/core/constants/app_dimens.dart';
import 'package:chromo_digital/gen/fonts.gen.dart';
...
class ThemeDark extends AppTheme {
  ...
  @override
  Color get primary => const Color(0xff7200A8);
  ...
  @override
  Color get cardColor => const Color(0xff202020);
  ...
  @override
  Color get canvasColor => const Color(0xff262626);
  ...
  InputDecorationTheme get inputDecorationTheme => InputDecorationTheme(
        ...
        border: OutlineInputBorder(
          borderSide: BorderSide(color: inputFieldIconColor, width: 2.0),
